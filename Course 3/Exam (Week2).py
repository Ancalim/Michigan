#Write code to assign to the variable map_testing all the elements in lst_check while adding the string “Fruit: ” to the
# beginning of each element using mapping

lst_check = ['plums', 'watermelon', 'kiwi', 'strawberries', 'blueberries', 'peaches', 'apples', 'mangos', 'papaya']
map_testing=map(lambda lstitem: "Fruit: " +lstitem, lst_check)
...
b_countries=filter(lambda city :"B" in city, countries)
...
passed=[clever[0] for clever in students if clever[1]>=70]
...
#Закопался на этом задании, плохое понимание задачи.


#Below, we have provided a species list and a population list. Use zip to combine these lists into one list of tuples
# called pop_info. From this list, create a new list called endangered that contains the names of species whose populations are below 2500.
...
print(pop_info)
endangered=[low[0] for low in pop_info if low[1]<2500]
