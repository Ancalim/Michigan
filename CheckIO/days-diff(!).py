...
#.days говорит нам о том что вернуть информацию нам надо в виде количества дней. А так как числа могут быть отрицательные, мы переводим их в абсолютную величину -4 = 4
